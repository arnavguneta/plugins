...
public class playerScoreboard {
	...
	public static void scoreGame(Player player, int timeLeft){
		...
		o.setDisplayName(ChatColor.GOLD + "" + ChatColor.BOLD + "TNT TAG");
	...
	public static void scoreLobby(Player player){
		...
		alive = o.getScore(ChatColor.WHITE + "Players: " + ChatColor.GREEN + Bukkit.getOnlinePlayers().size() + "" + ChatColor.WHITE + "/" + ChatColor.GREEN + plugin.gameManager.playersNeeded);
		alive.setScore(1);
